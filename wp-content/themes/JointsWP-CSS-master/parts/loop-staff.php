...
<article id="post-<?php the_ID(); ?>" <?php post_class(''); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
    ...
    <section class="entry-content" itemprop="text">
    	<div style="float:left; padding:0em 1em 1em 0em;"><?php the_post_thumbnail('full'); ?></div>
    	<h1 class="entry-title single-title" itemprop="headline" style="text-align:left;"><?php the_title(); ?></h1>
		<?php if( get_field('staff_title') ): ?>
		<h2 style="text-align:left;"><?php the_field('staff_title'); ?></h2>
		<?php endif; ?>
		...
		<?php if( get_field('staff_email') ): $shortcode = get_field('staff_email'); ?>
			...
			<p class="nomargin"><button class="non-button button download" data-open="contactModal">Contact <?php the_title(); ?></button></p>
		<?php endif; ?>
		<?php if( get_field('staff_linkedin') ): ?>
			<p class="nomargin"><a class="button info" href="<?php the_field('staff_linkedin'); ?>" target="_blank">Find me on LinkedIn!</a></p>
		<?php endif; ?>
		<br>
		<?php the_content(); ?>
